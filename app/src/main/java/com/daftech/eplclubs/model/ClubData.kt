...
object ClubData {
    val clubs = listOf(
        ...
        Club(
            ...
            "Selhurst Park",
            "25,486",
            "Crystal Palace Football Club (commonly referred to as simply Palace) is a professional football club based in Selhurst in the Borough of Croydon, South London, England. The club competes in the Premier League, the top tier of English football."
        ),
        Club(
            8,
            R.drawable.everton,
        ...
        Club(
            10,
            R.drawable.ipswich_town,
            "Ipswich",
            "Ipswich Town Football Club",
            "The Tractor Boys",
            "#345590",
            "16 October 1878; 145 years ago",
            "Portman Road",
            "30,014",
            "Ipswich Town Football Club is a professional football club based in Ipswich, Suffolk, East Anglia, England. The club compete in the Premier League, the top tier of English football, following back to back promotions from League One and the Championship."
        ),
        Club(
            11,
        ...
        Club(
            20,
            R.drawable.wolverhampton_wanderers,
            "Wolves",
